--SPS DEPARTAMENTOS
CREATE PROCEDURE SP_CREAR_DEPARTAMENTO (@nombre VARCHAR(50),
@direccion VARCHAR(100), @region VARCHAR(50), @ciudad VARCHAR(50), @precio NUMBER,
@disponibilidad BOOLEAN) AS
 ...
 CREATE PROCEDURE SP_DEL_DEPARTAMENTO (@id_departamento NUMBER) AS
   
   BEGIN
      DELETE FROM departamentos WHERE id_departamento = @id_departamento;
   END;
   
 CREATE PROCEDURE SP_UPD_DEPARTAMENTO (id_departamento INTEGER, @nombre VARCHAR(50),
...
--SPS  SERVICIOS-----------------------------------------------------------------------------------------
CREATE PROCEDURE SP_CREAR_SERVICIOS (@descripcion VARCHAR(50),@tipos_servicio_id_tipo INTEGER, @costo_operacion INTEGER,
 ...
 CREATE PROCEDURE SP_DEL_SERVICIOS (@id_servicios NUMBER) AS
   
   BEGIN
      DELETE FROM servicios WHERE id_servicios = @id_servicios;
   END;
   
 CREATE PROCEDURE SP_UPD_SERVICIOS (id_servicios NUMBER, @descripcion VARCHAR(50),@tipos_servicio_id_tipo INTEGER, @costo_operacion INTEGER,
 @valor_cliente INTEGER, @departamento_id_departamento NUMBER) AS
   ...
   END;
--SPS  tipos SERVICIOS-----------------------------------------------------------------------------------------
CREATE PROCEDURE SP_CREAR_TIPOS_SERVICIOS (@descipcion VARCHAR(250)) AS
 ...
 CREATE PROCEDURE SP_GET_TIPOS_SERVICIOS
   BEGIN
      SELECT * FROM tipos_servicios;
   END;
   
 CREATE PROCEDURE SP_DEL_TIPOS_SERVICIOS (@id_tipo NUMBER) AS
   
   BEGIN
      DELETE FROM tipos_servicios WHERE id_tipo = @id_tipo;
   END;
   
 CREATE PROCEDURE SP_UPD_TIPOS_SERVICIOS (@id_tipo NUMBER, @descripcion VARCHAR(250)) AS
   
   BEGIN
     UPDATE tipos_servicios SET descripcion = @descripcion WHERE id_tipo = @id_tipo;
   END;
----SPS  personas-----------------------------------------------------------------------------------------
CREATE PROCEDURE SP_CREAR_PERSONA (@rut VARCHAR(50),@nombre VARCHAR(50),@apellidos VARCHAR(50),@telefono VARCHAR(50),@Users_user_id INTEGER) AS
 ...
 CREATE PROCEDURE SP_DEL_PERSONA (@id_persona NUMBER) AS
   
   BEGIN
      DELETE FROM personas WHERE id_persona = @id_persona;
   END;
   
 CREATE PROCEDURE SP_UPD_PERSONA (@id_persona NUMBER, @rut VARCHAR(50),@nombre VARCHAR(50),@apellidos VARCHAR(50),@telefono VARCHAR(50),@Users_user_id INTEGER) AS
   ...
   END;
 ---SPS  inventarios-----------------------------------------------------------------------------------------
 CREATE PROCEDURE SP_CREAR_INVENTARIO (@descripcion VARCHAR(50),@Departamentos_id_departamento INTEGER) AS
 ...
 CREATE PROCEDURE SP_DEL_INVENTARIO (@id_inventario NUMBER) AS
   
   BEGIN
      DELETE FROM inventarios WHERE id_inventario = @id_inventario;
   END;
   
 CREATE PROCEDURE SP_UPD_INVENTARIO (@id_inventario NUMBER, @descripcion VARCHAR(50),@Departamentos_id_departamento INTEGER) AS
 ...
 --SPS Reservas-----------------------------------------------------------------------------------------
 CREATE PROCEDURE SP_CREAR_RESERVA (@fecha_entrada DATETIME,@fecha_salida DATETIME,@Departamentos_id_departamento INTEGER,@Personas_id_persona INTEGER,@Estadias_id_estadia INTEGER) AS
 ...
 CREATE PROCEDURE SP_DEL_RESERVA (@id_reserva NUMBER) AS
   
   BEGIN
      DELETE FROM Reservas WHERE id_reserva = @id_reserva;
   END;
   
 CREATE PROCEDURE SP_UPD_RESERVA (@id_reserva NUMBER, @fecha_entrada DATETIME,@fecha_salida DATETIME,@Departamentos_id_departamento INTEGER,@Personas_id_persona INTEGER,@Estadias_id_estadia INTEGER) AS
  ...
  --SPS Reservas-----------------------------------------------------------------------------------------
 CREATE PROCEDURE SP_CREAR_ESTADIA (@id_checkin INTEGER,@id_checkout INTEGER) AS
 ...
 CREATE PROCEDURE SP_GET_ESTADIA
   BEGIN
      SELECT * FROM Estadia;
   END;
   
 CREATE PROCEDURE SP_DEL_ESTADIA (@id_estadia NUMBER) AS
   
   BEGIN
      DELETE FROM Estadia WHERE id_estadia = @id_estadia;
   END;
   
 CREATE PROCEDURE SP_UPD_ESTADIA (@id_estadia INTEGER,@id_checkin INTEGER,@id_checkout INTEGER) AS
  ...
  --SPS Acompañante-----------------------------------------------------------------------------------------
 CREATE PROCEDURE SP_CREAR_ACOMPANANTE (@rut VARCHAR(50),@nombre VARCHAR(50),@apellido_pat VARCHAR(50),@apellido_mat VARCHAR(50),@Reservas_id_reserva INTEGER) AS
 ...
 CREATE PROCEDURE SP_GET_ACOMPANANTE
   BEGIN
      SELECT * FROM Acompanante;
   END;
   
 CREATE PROCEDURE SP_DEL_ACOMPANANTE (@id_acompanante NUMBER) AS
   
   BEGIN
      DELETE FROM Acompanante WHERE id_acompanante = @id_acompanante;
   END;
   
 CREATE PROCEDURE SP_UPD_ACOMPANANTE (@id_acompanante INTEGER,@rut VARCHAR(50),@nombre VARCHAR(50),@apellido_pat VARCHAR(50),@apellido_mat VARCHAR(50),@Reservas_id_reserva INTEGER) AS
...
END;	 
 ...
 --SPS Checkin-----------------------------------------------------------------------------------------
 CREATE PROCEDURE SP_CREAR_CHECKIN (@fecha DATETIME,@pago INTEGER) AS
 ...
 CREATE PROCEDURE SP_GET_CHECKIN
   BEGIN
      SELECT * FROM Checkin;
   END;
   
 CREATE PROCEDURE SP_DEL_CHECKIN (@id_checkin NUMBER) AS
   
   BEGIN
      DELETE FROM Checkin WHERE id_checkin = @id_checkin;
   END;
   
 CREATE PROCEDURE SP_UPD_CHECKIN (@id_checkin INTEGER,@fecha DATETIME,@pago INTEGER) AS
...
END;
 ...
 --SPS CheckOUT-----------------------------------------------------------------------------------------
 CREATE PROCEDURE SP_CREAR_CHECKOUT (@fecha DATETIME) AS
 ...
 CREATE PROCEDURE SP_GET_CHECKOUT
   BEGIN
      SELECT * FROM Checkout;
   END;
   
 CREATE PROCEDURE SP_DEL_CHECKOUT (@id_checkout NUMBER) AS
   
   BEGIN
      DELETE FROM Checkout WHERE id_checkout = @id_checkout;
   END;
   
 CREATE PROCEDURE SP_UPD_CHECKOUT (@id_checkout INTEGER,@fecha DATETIME) AS
...
END;
 ...
 --SPS Multas-----------------------------------------------------------------------------------------
 CREATE PROCEDURE SP_CREAR_MULTAS (@descripcion VARCHAR(50),@monto_multa INTEGER,@idCheckOut INTEGER) AS
 ...
 CREATE PROCEDURE SP_GET_MULTAS
   BEGIN
      SELECT * FROM Multas;
   END;
   
 CREATE PROCEDURE SP_DEL_MULTAS (@id_multas NUMBER) AS
   
   BEGIN
      DELETE FROM Multas WHERE id_multas = @id_multas;
   END;
   
 CREATE PROCEDURE SP_UPD_MULTAS (@id_multas INTEGER,@descripcion VARCHAR(50),@monto_multa INTEGER,@idCheckOut INTEGER) AS
...
END;
 ...
 CREATE PROCEDURE SP_DEL_MANTENCIONES (@id_mantencion NUMBER) AS
...
END;
 ...
 --SPS Resumen-----------------------------------------------------------------------------------------
 /*CREATE PROCEDURE SP_CREAR_RESUMEN (@ingreso INTEGER,@egreso INTEGER,@fecha DATETIME) AS
 ...
 CREATE PROCEDURE SP_GET_resumen
   BEGIN
      SELECT * FROM Resumen;
   END;
   
 CREATE PROCEDURE SP_DEL_RESUMEN (@id_resumen NUMBER) AS
   
   BEGIN
      DELETE FROM Resumen WHERE id_resumen = @id_resumen;
   END;
   
 CREATE PROCEDURE SP_UPD_RESUMEN (@id_resumen INTEGER,@idDepartamento INTEGER,@Descripción VARCHAR(50),@fecha DATETIME,@costo INTEGER) AS
...
END;*/
 ...
 CREATE PROCEDURE SP_DEL_USERS (@user_id NUMBER) AS
...
END;
 ...
 --SPS Profiles-----------------------------------------------------------------------------------------
 CREATE PROCEDURE SP_CREAR_PROFILES (@profile_name VARCHAR(50)) AS
 ...
 CREATE PROCEDURE SP_DEL_PROFILES (@profile_id NUMBER) AS
   
   BEGIN
      DELETE FROM Profiles WHERE profile_id = @profile_id;
   END;
   
 CREATE PROCEDURE SP_UPD_PROFILES (@profile_id INTEGER,@profile_name VARCHAR(50)) AS
